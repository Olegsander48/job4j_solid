...
class WarehouseTest {
    @Test
    void whenAddBreadThenGetItInWarehouse() {
        ...
        Bread bread = new Bread("Borodinskiy",
                ...
                0,
                230.50);
        boolean result = warehouse.add(bread);
        assertThat(result).isTrue();
    }

    @Test
    void whenAddExpiredBreadThenDontGetItInWarehouse() {
        Warehouse warehouse = new Warehouse();
        Bread bread = new Bread("Borodinskiy",
                LocalDateTime.of(2024, 12, 30, 17, 25),
                LocalDateTime.of(2024, 9, 8, 11, 34),
                25,
                0,
                230.50);
        boolean result = warehouse.add(bread);
